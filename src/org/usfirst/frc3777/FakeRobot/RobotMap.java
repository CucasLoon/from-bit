...
public class RobotMap {
    ...
    public static void init() {
        ...
        compressorCompressor1.setClosedLoopControl(true);
        compressorCompressor1.setClosedLoopControl(false);
        
        boolean enabled = compressorCompressor1.enabled();
        boolean pressureSwitch = compressorCompressor1.getPressureSwitchValue();
        float current = compressorCompressor1.getCompressorCurrent();
